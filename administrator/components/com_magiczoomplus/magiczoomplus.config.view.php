...
<table class="adminlist magictoolbox" style="width: auto;">
    <tr>
        ...
        <th class="title<?php if($c['name'] == 'default') echo ' def';?>" width="100px">
            ...
            <br />
            <a class="settings" href="<?php echo $index2File?>?option=com_magiczoomplus&page=magiczoomplus.config&profile=<?php echo $c['id']?>">Edit</a>
        </th>
        <?php endforeach ?>
    </tr>
        ...
        if(!in_array($groupName,array('module'))):?>
            ...
            <?php $i=0;foreach($group['params'] as $param):$i++;?>
                ...
                <tr class="row<?php echo $i%2?>">
                    ...
                    ?>
                    <th><b><?php echo $labels['1'];?><?php if(isset($param['description']) && !empty($param['description'])) { ?> (<a class="magictooltip" title="<?php echo htmlspecialchars($param['description'], ENT_COMPAT, 'UTF-8'); ?>" >?</a>)<?php } ?></b><span><?php echo $labels['2'];?></span></th>
