    ...
    switch ($action) {
        case 'savealternates':
            ...
            if(is_array($alternates)) {
                ...
                $query = "INSERT INTO #__virtuemart_mz_product_files(file_id,is_alternate,advanced_option) VALUES".join(',',$values)." ON DUPLICATE KEY UPDATE is_alternate = VALUES(is_alternate),advanced_option = VALUES(advanced_option)";
        ...
        case 'newhotspot':
            ...
            $query = 'INSERT INTO #__virtuemart_mz_product_hotspots SET '.join(',',$w);
        ...
        case 'savehotspots':
            ...
            foreach($hotspots as $id => $params) {
                ...
                if(isset($params['delete'])) {
                    ...
                    $query[] = 'UPDATE #__virtuemart_mz_product_hotspots SET '.join(',',$i)." WHERE id = $id";
                }
            }

            if(count($delete)){
                $query[] = 'DELETE FROM #__virtuemart_mz_product_hotspots WHERE id IN('.join(',',$delete).')';
            }
